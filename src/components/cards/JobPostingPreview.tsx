...
import { Clock, MapPin, DollarSign, Edit3, Briefcase, Users, Star } from "lucide-react"; 
  ...
  return (
    <div className="min-h-screen ">
          ...
          <div className="p-8">
            <div className="flex items-center justify-between mb-6">
              ...
              >
                ...
                <span className="font-medium text-gray-700 group-hover:text-blue-700">Edit Posting</span>
              </button>
            </div>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-2xl font-bold text-green-800">
                      {salaryMin ? `$${parseInt(salaryMin).toLocaleString()}` : "N/A"} - {salaryMax ? `$${parseInt(salaryMax).toLocaleString()}` : "N/A"}
                    </p>
                  </div>
                </div>
              </div>
      ...
      <section className="py-8 ">
        ...
        <p className="text-gray-700 bg-gray-50 p-4 rounded whitespace-pre-line">{description}</p>
      </section>

      {/* What We're Looking For */}
      <section>
        <h3 className="text-lg font-semibold border-l-4 border-pink-600 pl-3 mb-4">What We're Looking For</h3>
        <p className="text-gray-700 bg-pink-50 p-4 rounded whitespace-pre-line">{requirements}</p>
      </section>
          </div>
        </div>
