            ...
            <div className="bg-blue-50 rounded-lg p-8">
              ...
              <div className="space-y-3">
                <div>
                  ...
                  <p className="text-sm text-gray-600">Questions about finding jobs, applying, or your profile</p>
                </div>
                <div>
                  <h4 className="font-medium text-gray-900">For Employers</h4>
                  <p className="text-sm text-gray-600">Help with posting jobs, managing candidates, or billing</p>
                </div>
                <div>
                  <h4 className="font-medium text-gray-900">Technical Issues</h4>
                  <p className="text-sm text-gray-600">Website problems, login issues, or bug reports</p>
                </div>
              </div>
            </div>
